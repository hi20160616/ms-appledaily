...
import (
	...
	"github.com/hi20160616/ms-appledaily/internal/job"
	"github.com/hi20160616/ms-appledaily/internal/server"
...
func main() {
	...
	g.Go(func() error {
		log.Printf("[%s] MS start at: %s",
			...
			configs.Data.MS["appledaily"].Addr)
	...
	// Job
	g.Go(func() error {
		log.Printf("[%s] Job is working", configs.Data.MS["appledaily"].Title)
